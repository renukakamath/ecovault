...
public class devilieryboyregistration extends AppCompatActivity  implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devilieryboyregistration);
...
//                }
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    JR.json_response = (JsonResponse) devilieryboyregistration.this;
                    String q ="/devilieryboyregistration?fname="+fname+"&place="+place+"&phone="+phone+"&email="+email+"&username="+user+"&password="+password+"&longitude="+LocationService.logi+"&latitude="+LocationService.lati;
                    q = q.replace(" ","%20");
                    JR.execute(q);
                }
            }
