...
//                }
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    String q ="/userregister?fname="+fname+"&place="+place+"&phone="+phone+"&email="+email+"&username="+user+"&password="+password+"&longitude="+LocationService.logi+"&latitude="+LocationService.lati;
                    q = q.replace(" ","%20");
                    JR.execute(q);
                }
            }
